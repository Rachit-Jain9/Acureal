...
// Live liveness snapshot from /api/admin/system-health. Runs the same four
// subsystem checks as the hourly watchdog cron (AI provider error share,
// audit-write liveness, stuck extractions, tenant-isolation fail-closed canary)
// on demand — no Sentry alerts (the cron owns alerting).
//
