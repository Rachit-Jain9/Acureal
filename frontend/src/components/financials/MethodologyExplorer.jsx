    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <StepRow idx="2" tone="sky" title="Deterministic engine runs the math"
          body="The TypeScript financial kernel executes BigInt-backed Decimal math — no LLMs, no Monte Carlo noise. The same inputs always produce the same outputs, down to four decimal places." />
