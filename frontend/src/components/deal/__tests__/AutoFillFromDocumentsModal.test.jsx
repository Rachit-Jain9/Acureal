  ...
  field_map: {
    survey_number: {
      ...
      signal: {
        ...
        lane: 'legal_title',
        grounded: true,
        reason: 'Found verbatim in the document text, but this is a title & ownership fact — Acureal never fills these automatically. Verify against the source document before applying.',
      },
      document_id: 'doc-1',
    ...
    land_area_sqft: {
      ...
      signal: {
        ...
        lane: null,
        grounded: null,
        reason: 'Read by AI. Acureal could not verify it against the document text — check it against the source.',
      },
      document_id: 'doc-1',
      document_name: 'sale-deed.pdf',
      doc_type: 'sale_deed',
