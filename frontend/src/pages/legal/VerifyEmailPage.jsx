        ...
        <section className="bg-white rounded-sm border border-hairline shadow-sm p-8">
          {isPending && (
            <div className="flex flex-col items-center text-center">
              <Loader2
                className="text-content-muted animate-spin motion-reduce:animate-none"
                size={36}
              />
          ...
          {isError && (
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-2">
                ...
                <Link
                  to="/"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded border border-hairline text-content-secondary text-sm font-medium hover:bg-bg-secondary transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c2410c]/40"
                >
                  Home
                </Link>
              </div>
