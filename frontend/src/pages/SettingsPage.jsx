...
import { User, Users, Shield, Lock, Palette, Save, Loader2, Brain, KeyRound } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      {/* Team & members — owner/admin only. Links to the dedicated Team page. */}
      {(user?.role === 'owner' || user?.role === 'admin') && (
        <div className="bg-bg-elevated rounded-xl shadow-sm border border-hairline-strong p-6">
          ...
          <p className="text-xs text-content-secondary mb-4 max-w-2xl">
            Invite teammates, set what each person can do, and verify your company
            email domain so colleagues join this workspace automatically.
          </p>
          <Link
