...
| ~~Provenance chips on deal fields~~ | ~~tiny "from sale-deed.pdf" chip next to auto-filled fields~~ | ~~1-2 sessions~~ | ~~Cross-cutting visual that makes every auto-filled field self-documenting~~ | ✅ **LANDED 2026-05-19** (PR-NX50 #406) |
| ~~Live AI Risk narrative panel on RiskTab~~ | ~~surface DOCX Risk Register synthesis inline~~ | ~~1 session~~ | ~~Operators no longer need DOCX to read Claude risk synthesis~~ | ✅ **LANDED 2026-05-19** (PR-NX47 #403) |
| ~~Live AI Sensitivity narrative panel on FinancialsPage~~ | ~~surface DOCX Sensitivity narrative inline~~ | ~~1 session~~ | ~~Surfaces driver decomposition + stress tests in live workspace~~ | ✅ **LANDED 2026-05-19** (PR-NX48 #404) |
| ~~Live AI Cross-Document Analysis panel on DocumentsTab~~ | ~~surface DOCX Document-Derived Insights inline~~ | ~~1 session~~ | ~~Catches cross-doc inconsistencies in live workspace, not only at export~~ | ✅ **LANDED 2026-05-19** (PR-NX49 #405) |
...
| **2** | **Live market-benchmark warnings on financial input forms** — port PR-NX28/NX33 validators to fire as the operator types in the Financials page, not only at export time | 1 session | Catches mistakes at input time, not 5 hours later at export | 🔴 NOT STARTED |
| **3** | **"One Brain" unified DealContext** — TODO_ARCHITECTURE.md Phase A (read consolidation) ships as a standalone win | 1 sprint | Entry criteria now met (kernel consolidation done, Python engine retired). Phase A is a single `/api/deals/:id/workspace` endpoint serving all tabs. | 🔴 NOT STARTED |
