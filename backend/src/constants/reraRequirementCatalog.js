...
const RERA_REQUIREMENTS = [
  ...
  },
  {
    ...
    weight: 4,
    detect: { docNamePatterns: [/title.*report/i, /search.*report/i, /advocate.*report/i, /title.*opinion/i] },
  ...
  },
  {
    ...
    weight: 4,
    applies_when: [{ field: 'assetClass', op: 'in', value: BUILDING_CLASSES }],
    detect: { docNamePatterns: [/structural.*safety/i, /structural.*stability/i, /structural.*certificate/i] },
  ...
  },
  {
    ...
    weight: 4,
    detect: { docNamePatterns: [/form[\s-]*1\b/i, /ca.*certificate/i, /project.*cost.*certificate/i], extractedFields: ['project_cost'] },
  ...
  },
  {
    ...
    weight: 3,
    detect: { docNamePatterns: [/bank.*affidavit/i, /bank.*letter/i, /no.*lien/i, /cancelled.*cheque/i] },
  ...
  // ── Professional Certificates ──────────────────────────────────────────────
  {
    ...
    weight: 3,
    detect: { docNamePatterns: [/architect.*appoint/i, /architect.*letter/i, /\bcoa\b/i, /form[\s-]*2\b/i] },
  ...
  },
  {
    ...
    weight: 3,
    detect: { docNamePatterns: [/engineer.*appoint/i, /engineer.*letter/i, /structural.*engineer/i, /form[\s-]*3\b/i] },
  ...
  },
  {
    ...
    weight: 3,
    detect: { docNamePatterns: [/\bca\b.*appoint/i, /chartered.*accountant/i] },
